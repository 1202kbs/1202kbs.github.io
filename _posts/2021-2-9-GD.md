...
\begin{aligned}
nf(x_n) - \sum_{k = 0}^{n - 1} f(x_{k + 1}) &= \sum_{k = 0}^{n - 1} \left\{ (k + 1) f(x_{k + 1}) - k f(x_k) \right\} - \sum_{k = 0}^{n - 1} f(x_{k + 1}) \\\\ &= \sum_{k = 0}^{n - 1} k(f(x_{k + 1}) - f(x_k)) \leq 0
\end{aligned}
...
\begin{aligned}
2L^{-1} t_n^2 (f(x_n) - f(x^*)) = 2L^{-1} t_n^2 \Delta_n &\leq 2L^{-1} \Delta_1 + \|x_1 - x^*\|^2 \\\\ &= 2L^{-1}(f(x_1) - f(x^*)) + \|x_1 - x^*\|^2 \\\\ &= 2L^{-1} \left( f(x_1) - f(x^*) + \frac{L}{2} \|x_1 - x^*\|^2 \right) \\\\ &\leq \|x_0 - x^*\|^2
\end{aligned}
